...
task2=SparkKubernetesOperator(
    task_id='OracleDB_Outbound_to_Delta_Lake',
    application_file="OracleDB_Outbound.yaml",
    do_xcom_push=True,
    dag=dag,
...
task3 = SparkKubernetesSensor(
    ...
    application_name="{{ task_instance.xcom_pull(task_ids='OracleDB_Outbound_to_Delta_Lake')['metadata']['name'] }}",
    dag=dag,
    api_group="sparkoperator.hpe.com",
    attach_log=True
)
