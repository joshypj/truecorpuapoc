...
task2=SparkKubernetesOperator(
    task_id='MySQL_kafka_read',
    application_file="True_Corp_MySQL_CDC.yaml",
    do_xcom_push=True,
    dag=dag,
...
task3 = SparkKubernetesSensor(
    task_id='MySQL_kafka_monitor',
    application_name="{{ task_instance.xcom_pull(task_ids='MySQL_kafka_read')['metadata']['name'] }}",
    dag=dag,
    api_group="sparkoperator.hpe.com",
    attach_log=True
)
